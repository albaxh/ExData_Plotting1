...
# Draw plot
plot(hhpc$Time,hhpc$Sub_metering_1,type="n",xlab="",ylab="Energy sub metering")
with(hhpc,lines(Time,as.numeric(Sub_metering_1)))
with(hhpc,lines(Time,as.numeric(Sub_metering_2),col="red"))
with(hhpc,lines(Time,as.numeric(Sub_metering_3),col="blue"))
